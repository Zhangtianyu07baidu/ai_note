...
result = note.gpt_analysis("分析一下这周我拜访了哪几位客户，分别拜访了几次，将重要信息提取到简化的excel表格中")
print(result)
# result = note.call_save("2024年5月20日，我拜访了客户李勇，他是自来水的主任，他的联系方式是13823454563")
# print(result)
# result = note.call_query("搜索：客户李勇的联系方式")
# print(result)